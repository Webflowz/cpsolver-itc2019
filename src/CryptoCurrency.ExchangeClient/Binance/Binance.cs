        ...
        public ICollection<SymbolCodeEnum> Symbol
        {
            get
            {
                return new List<SymbolCodeEnum>
                {
                    ...
                    SymbolCodeEnum.ADAPAX,
                    SymbolCodeEnum.ADAUSDC,
                    ...
                    SymbolCodeEnum.DASHBNB,
                    SymbolCodeEnum.NANOUSDT,
                    SymbolCodeEnum.OMGUSDT,
                    SymbolCodeEnum.OMGBNB,
                    SymbolCodeEnum.THETAUSDT,
                    SymbolCodeEnum.IOSTBNB,
                    SymbolCodeEnum.IOSTUSDT,
                    SymbolCodeEnum.ZECBNB,
                    SymbolCodeEnum.ZECUSDT,
                    SymbolCodeEnum.ZECPAX,
                    SymbolCodeEnum.ZECTUSD,
                    SymbolCodeEnum.ZECUSDC,
                    SymbolCodeEnum.XMRBNB,
                    SymbolCodeEnum.XMRUSDT,
                    SymbolCodeEnum.ZRXBNB,
                    SymbolCodeEnum.ZRXUSDT
                };
            }
        }
